<?php
// home.php – RC Repair Café forside
?>
...
<main>
    ...
    <section class="info-section" aria-labelledby="hvad-er-heading">
        <article class="info-block">
            <h2 id="hvad-er-heading">Hvad er Repair Café?</h2>
            <p>
    ...
    <section class="info-section alt" aria-labelledby="baeredygtighed-heading">
        <article class="info-block">
            <h2 id="baeredygtighed-heading">Bæredygtighed</h2>
            <p>
    ...
    <section class="info-section" aria-labelledby="faellesskab-heading">
        <article class="info-block">
            <h2 id="faellesskab-heading">Fællesskab</h2>
            <p>
                Repair Café handler ikke kun om en grønnere fremtid - det handler også om mennesker.
                Her møder du andre med interesse for håndværk, bæredygtighed, fjernstyret legetøj og samarbejde på tværs af aldersgrupper.
            </p>
            <p>
    ...
    <section class="cta" aria-labelledby="cta-heading">
        <h2 id="cta-heading">Klar til at komme i gang?</h2>
